...
type Info struct {
	...
	OpenCodeReviewVersion string `json:"openCodeReviewVersion"`
	OrcaVersion           string `json:"orcaVersion"`
	OpenHandsVersion      string `json:"openHandsVersion"`
...
func Current() Info {
	return Info{Name: "AgentHub", Version: Version, Commit: Commit, BuildTime: BuildTime, BaseVersion: BaseVersion, LangflowVersion: LangflowVersion, QwenCodeVersion: QwenCodeVersion,
		...
		OpenCodeReviewVersion: OpenCodeReviewVersion, OrcaVersion: OrcaVersion, OpenHandsVersion: OpenHandsVersion, PiVersion: PiVersion}
}

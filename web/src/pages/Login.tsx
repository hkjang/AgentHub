...
export function Login({version,onLogin}:{version:Version;onLogin:()=>Promise<void>}) {
  ...
  return <main className="login-page">
    <section className="login-story"><div className="story-glow"/><div className="login-brand"><img src="/logo.svg" alt="AgentHub Logo" className="brand-logo-img large" /><span>AgentHub</span></div><div className="story-copy"><span className="eyebrow light">Enterprise Agent Runtime Platform</span><h1>Agent가 일할<br/><em>안전한 공간.</em></h1><p>Agent Runtime, Workspace, MCP와 Model을 하나의 통제면에서 운영하세요.</p><div className="feature-row"><span><Boxes size={18}/>Persistent Workspace</span><span><ShieldCheck size={18}/>Policy by Default</span></div></div><div className="story-foot"><span className="status-dot online"/>Offline-ready control plane</div></section>

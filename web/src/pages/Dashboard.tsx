...
export function Dashboard(){
  ...
  return <div className="page"><PageHeader eyebrow="컨트롤 플레인" title={`${user.displayName}님, 안녕하세요`} description="에이전트 런타임과 작업공간 상태를 한눈에 확인하세요." actions={<Link className="button primary" to="/catalog"><Plus size={17}/>새 에이전트</Link>}/>
